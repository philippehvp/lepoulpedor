<?php
  ...
  $sql =    '   SELECT    pronostiqueurs.Pronostiqueur' .
            ...
            '	  LEFT JOIN	(' .
            '					    SELECT		classements.Pronostiqueurs_Pronostiqueur, classements.Journees_Journee, classements.Classements_ClassementGeneralButeur, classements.Classements_PointsGeneralButeur' .
            '					    FROM		  classements' .
            '    					JOIN		  (' .
            ...
            '             AND   classements.Classements_ClassementGeneralButeur IS NOT NULL' .
            '   ORDER BY  classements.Classements_ClassementGeneralButeur';
